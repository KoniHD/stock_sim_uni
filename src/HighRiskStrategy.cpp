...
auto HighRiskStrategy::pickStocks(double &invested_funds, const StockMarket &stockMarket) const noexcept
        -> std::unordered_map<std::string, unsigned>
{
    ...
    portfolio.merge(purchaseStocks(invested_funds, invested_funds, high_risk_stocks_copy));
